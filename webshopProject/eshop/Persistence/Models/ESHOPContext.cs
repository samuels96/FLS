...
namespace eshop.Persistence.Models
{
    public partial class ESHOPContext : DbContext
    {
        ...
        public ESHOPContext(DbContextOptions<ESHOPContext> options, ModelBuilder modelBuilder)
            : base(options)
        {
        ...
        public virtual DbSet<ProductStockAudit> ProductStockAudit { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ProductStockAudit>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("productStockAudit");

                entity.Property(e => e.Date).HasColumnType("date");

                entity.Property(e => e.NewStock).HasMaxLength(100);

                entity.Property(e => e.OldStock).HasMaxLength(100);
